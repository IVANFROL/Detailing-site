...
const pricingData = [
  ...
  },
  {
    ...
    services: [
      { name: "Антигравийная пленка", price: "по запросу" },
      { name: "Оклейка машин", price: "по запросу" },
      { name: "Плёнки архитектурные, декоративные, защитные", price: "по запросу" },
    ],
  },
  {
    category: "ПОКРЫТИЯ",
    services: [
      ...
      { name: "Керамическое покрытие", price: "по запросу" },
    ],
  },
  {
    ...
    services: [
      ...
      { name: "Устранение запахов в автомобиле", price: "по запросу" },
    ],
  },
]
